  ...
  <li class="list-group-item"><?=$title_category_product?></li></a> 
                    ...
                    <ul class="list-group" style="width: 270px;">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8"><?=$title_product?> <br> (- <?=$discount_product?>%)<br><br><b><?=number_format($price_product-($price_product*$discount_product/100))?> VNĐ</b></div>
                                </div>
                            </li>
            ...
            ?>
                ...
                <a href="<?php echo BASE_URL ?>/product/detail_product/<?=$id_product?>"><span class="chi-tiet">CHI TIẾT</span></a>
                    ...
                    <a href="<?php echo BASE_URL ?>/product/detail_product/<?=$id_product?>"><img  src="<?php echo BASE_URL ?>/public/uploads/product/<?=$image_product?>" alt=""><span class='hang-moi'>Hàng mới</span></a>
                    <div class="glow-wrap">
    <i class="glow"></i>
  </div>
                    <div class="text">
